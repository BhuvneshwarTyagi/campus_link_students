...
class _NavigationState extends State<Navigation> {
  ...
  int confimations =
      usermodel["Confirmation"] != null ? usermodel["Confirmations"].length : 0;
        ...
        child: Scaffold(
            ...
            actions: [
              StreamBuilder(
                stream: FirebaseFirestore.instance
                    .collection("Messages")
                    .where(usermodel["Email"].toString().split("@")[0],
                        isNull: false)
                    .snapshots(),
                builder: (context, snapshot) {
                  ...
                  for (int i = 0; i < end; i++) {
                    print(i);
                    int read = snapshot.data?.docs[i]
                            .data()[usermodel["Email"].toString().split("@")[0]]
                        ["Read_Count"];
              ...
              children: <Widget>[
                ...
                ListTile(
                  leading: SizedBox(
                      ...
                      child: Image.asset(
                        "assets/images/psychometric.png",
                        fit: BoxFit.contain,
                      )),
                ...
                ListTile(
                  ...
                  title: Row(
                    ...
                    children: [
                      ...
                      Text(
                          '${usermodel['Study_hours']} : ${usermodel['Study_minute']} ${usermodel['Study_section']}',
                  ...
                  onTap: () async {
                    ...
                    await FirebaseFirestore.instance
                        ...
                        .doc(usermodel['Email'])
                        .update({
                      'Study_hours': studyTime.hour,
                      'Study_minute': studyTime.minute,
                      'Study_section': studyTime.period.toString().split('.')[1]
                    });
                    await database()
                        .fetchuser()
                    ...
                    if (usermodel["Message_channels"] != null) {
                      ...
                      for (var channel in channels) {
                        await FirebaseFirestore.instance
                            ...
                            .doc(channel)
                            .update({
                          "${usermodel["Email"].toString().split("@")[0]}.Token":
          ...
          endDrawer: Drawer(
            child: confimations == 0
                ...
                : AutoSizeText(
                    "No Alters / Confirmations pending",
                    style: GoogleFonts.tiltNeon(color: Colors.black),
                  ),
          ),
